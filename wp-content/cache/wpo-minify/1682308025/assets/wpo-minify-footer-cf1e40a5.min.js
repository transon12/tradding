...
(function(jQuery){jQuery(document).on('click','.code',function(){console.log('aaa')
var data=jQuery(this).find('.code_stocks').text();jQuery('.showstocks').click();setTimeout(function(){new FireAnt.QuoteWidget({"container_id":"fan-quote-520","symbols":data,"locale":"vi","price_line_color":"#71BDDF","grid_color":"#999999","label_color":"#999999","width":"100%","height":"300px"})},1000)})
jQuery(document).on('click','.item-code-btn',async function(){var code=jQuery(this).attr('data-code');await getInfoCommon(code)
console.log(code)
codeStock=code})})(jQuery);var COLOR_PURPLE="#B64FF5",COLOR_YELLOW="#FEC703",COLOR_BLUE_ACCESS="#48C1CC",COLOR_GREEN="#60B523",COLOR_RED="#E63124"
var RESULT_PRICE={}
async function callApi(endPoint,method,isToken=!0,body,isJson=!1){var myHeaders=new Headers();var requestOptions={method:method,redirect:'follow',};if(isToken){myHeaders.append("Authorization","Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsIng1dCI6IkdYdExONzViZlZQakdvNERWdjV4QkRITHpnSSIsImtpZCI6IkdYdExONzViZlZQakdvNERWdjV4QkRITHpnSSJ9..dA5-HVzWv-BRfEiAd24uNBiBxASO-PAyWeWESovZm_hj4aXMAZA1-bWNZeXt88dqogo18AwpDQ-h6gefLPdZSFrG5umC1dVWaeYvUnGm62g4XS29fj6p01dhKNNqrsu5KrhnhdnKYVv9VdmbmqDfWR8wDgglk5cJFqalzq6dJWJInFQEPmUs9BW_Zs8tQDn-i5r4tYq2U8vCdqptXoM7YgPllXaPVDeccC9QNu2Xlp9WUvoROzoQXg25lFub1IYkTrM66gJ6t9fJRZToewCt495WNEOQFa_rwLCZ1QwzvL0iYkONHS_jZ0BOhBCdW9dWSawD6iF1SIQaFROvMDH1rg");requestOptions.headers=myHeaders}
...
async function getInfoCommon(codeStock){console.log(codeStock);var fundalmental="https://restv2.fireant.vn/symbols/"+codeStock+"/fundamental"
...
jQuery(document).ready(async function(){await getInfoCommon()})
...
jQuery(document).ready(function(){var ulNewsWrapperWidth=jQuery(".news-wrapper .inner ul").width();var marqueeWidth=ulNewsWrapperWidth+1000;var secondNewsWrapper=parseInt((marqueeWidth-1000)/30)+'s';jQuery(".news-wrapper .inner ul").css({'animation':'n-carousel '+secondNewsWrapper+' linear infinite','-webkit-animation':'n-carousel '+secondNewsWrapper+' linear infinite'});jQuery.keyframe.define([{name:'n-carousel','100%':{'-webkit-transform':"translate3d(-"+marqueeWidth+"px,0,0)",'transform':"translate3d(-"+marqueeWidth+"px,0,0)"}}]);jQuery(".news-wrapper .inner ul").mouseover(function(){jQuery(this).css({'-webkit-animation-play-state':'paused','animation-play-state':'paused'})});jQuery(".news-wrapper .inner ul").hover(function(){jQuery(this).css({'-webkit-animation-play-state':'running','animation-play-state':'running'})});console.log(1111)});
