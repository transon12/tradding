...
<section class="section bg-white pt-1 mobile-sidebar no-scrollbar mfp-hide" id="sidebar-chart" style="background-color:#f4f6f9">
    <div class="row">

        <div class="col-md-6 col-lg-7 col-sm-12 col-xs-12">
			<div class="d-flex justify-content-between pl-5 pt-3 font-weight-bold"> <span class="text-success" id="ho_tro_manh"></span>
			<span id='khang_cu_manh' class="text-danger"></span></div>
        ...
        <div class="col-md-6 col-lg-5 col-sm-12 col-xs-12 pl-1 pt-3">
